  ...
  public class Program
    {
         static void Main(string[] args)
        {
            ...
            #region
            PresentCollection<SweetClass> present = new PresentCollection<SweetClass>(1000);
             ...
             foreach (var c in present.GetSortedSweets(ComparatorsForISweet.CaloriesCompare)) {
                 Console.WriteLine(c + "\n");
             }
